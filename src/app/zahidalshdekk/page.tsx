          ...
          <div className="w-full flex flex-col pt-12 sm:pt-20 pb-32 animate-in fade-in slide-in-from-bottom-24 duration-[1.5s]">
            ...
            <div className="text-base sm:text-lg leading-loose space-y-10 px-2 sm:px-4 text-neutral-300">
              ...
              <div className="space-y-8">
                <p>
                  Та хааяа “манай үеийнхэн ийм амжилттай явж байна” гэж хэлэхэд би их эмзэглэдэг. Ээжээ, та ч бас над шиг мөрөөдөлтэй, хүсэл зорилготой жаахан хүүхэд байсан шүү дээ. Тэр бүхнээ ардаа орхиод намайг, миний дүүг өсгөхийн төлөө бүхнээ зориулсан гэж бодохоор иx сэтгэл хүндрүүлдэг гэхдээ та ийм сайн хүмүүжилтэй хоёр хүүхэдтэй азтай ээж шүү дээ
.
                </p>

                <p>
                  Нэг удаа аав утсаа авахгүй байхад би урт мессеж бичих гэж байгаад уйлж байсан юм. “Аав хэзээ ч үүргээ биелүүлээгүй, харин та бид хоёрын төлөө бүх хүнд хэцүүг шүд зуун давж гарсан” гэж бичиж суухдаа таныг яаж энэ их зүйлтэй ганцаархнаа тэмцэж болгож ирснийг бодхоор л уйлчихсан
.
                </p>
              </div>
